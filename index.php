...
<html lang="en">
  <head>
    ...
    <title>Hearnime - Listen Anime Songs</title>
  </head>
  <body>

    <nav class="navbar navbar-expand-lg p-3">
      <div class="container">
        <a class="navbar-brand wow bounceInDown" href="#"><h3>Hearnime!</h3></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a class="nav-item nav-link enjoy-now btn btn-primary wow bounceInDown" href="dashboard.php" data-wow-duration="2.5s" data-wow-delay="0.2s" data-toggle="modal" data-target="#signIn">Sign In</a>
          </div>
        </div>
      </div>
    </nav>
    ...
    <section>
      <div class="container headup mb-5">
        <div class="row">
          <div class="col-md-5">
            <h1 class="mb-2 wow fadeInLeft">Listen and enjoy to your favorite anime music now.</h1>
          ...
          <div class="col-md-7 mt-3">
            <img src="assets/images/2.png" class="wow fadeInRight">
          </div>
        </div>
      </div>
    </section>
    ...
    <section style="background-image: url(http://localhost/Uprising/assets/images/feature-bg-1.png); background-size: cover;">
      <div class="container trends">
        ...
        <div class="row">
          <div class="col-md-5 wow bounceInLeft"><img src="assets/images/index.png" width="350"></div>
          <div class="col-md-7">
      ...
      <div class="container">
        <div class="row">
            <div class="col-lg-10 col-md-12 pt-0">
                <p>Copyright 2020 <a href="">Hearnime</a> &copy; All Rights Reserved</p>
            </div>
